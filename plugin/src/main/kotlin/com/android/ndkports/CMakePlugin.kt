...
/**
 * Cloned from https://github.com/google/prefab/blob/e6fe0aa17f88a5c5d34e75db0ec1cdffe2f99d6c/cmake-plugin/src/main/kotlin/com/google/prefab/cmake/CMakePlugin.kt
 */
...
class CMakePlugin(
    ...
    override val packages: List<com.google.prefab.api.Package>
...
//            )
    ...
    private fun generatePackage(
        pkg: com.google.prefab.api.Package,
        ...
        val pkgDirectory = if (useArchSpecificLayout) {
            outputDirectory.resolve(
                "${requirements.targetTriple}/lib/cmake/${pkg.name}"
            ).apply { mkdirs() }
        } else {
            outputDirectory
        }
